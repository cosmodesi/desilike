...
def parse_args():
    ...
    p.add_argument("--model", default="IDE", help="MG model label used by fkptjax (e.g. HDKI or HS)")
    # p.add_argument(
    #     "--mg-variant",
    #     default="mu_OmDE",
    ...
    p.add_argument(
        "--data-dir",
        type=Path,
        default=Path("/global/homes/n/nishavk/desilike/MG/synthetic_data/"),
...
def apply_oldstyle_cosmo_and_ide_priors(cosmo: Cosmoprimo, args):
    ...
    # for thawing models, here I would add w, wp etc as well    
...
def main():
    ...
    # default 
    # check the cosmoprimo noteboook
