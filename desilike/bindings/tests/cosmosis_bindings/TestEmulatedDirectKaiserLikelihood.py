...
TestEmulatedDirectKaiserLikelihood = CosmoSISLikelihoodFactory(TestEmulatedDirectKaiserLikelihood, 'TestEmulatedDirectKaiserLikelihood', kw_like={}, module=__name__)
