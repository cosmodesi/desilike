...
class PowerSpectrumMultipolesLikelihood(BaseGaussianLikelihood):
    ...
    def __init__(self, zeff=None, fiducial=None, wmatrix=None, **kwargs):
        flatdata, shotnoise, covariance, nobs = self.load_data(**kwargs)
        super(PowerSpectrumMultipolesLikelihood, self).__init__(covariance=covariance, data=flatdata, nobs=nobs)
        self.requires['theory'] = (WindowedPowerSpectrumMultipoles,
    ...
    def load_data(self, covariance=None, data=None, covariance_scale=1.0, klim=None, kstep=None, krebin=None):
        ...
        return flatdata, shotnoise, covariance, nobs
...
class BAOPowerSpectrumMultipolesLikelihood(PowerSpectrumMultipolesLikelihood):
