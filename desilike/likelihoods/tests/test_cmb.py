"""Tests for the Planck NPIPE (PR4) CamSpec high-ell CMB likelihood.
...
from desilike.likelihoods.cmb import TTTEEEHighlPlanckNPIPECamspecLikelihood, TTHighlPlanckNPIPECamspecLikelihood
