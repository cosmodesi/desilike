...
def test_correlation_function():
    ...
    observable = TracerCorrelationFunctionMultipolesObservable(slim={0: [20., 150.], 2: [20., 150.]}, sstep=5.,
...
def test_covariance_matrix():
    ...
    theory = KaiserTracerPowerSpectrumMultipoles(template=template)
    footprint = BoxFootprint(volume=1e10, nbar=1e-3)
    observable = TracerPowerSpectrumMultipolesObservable(klim={0: [0.05, 0.2], 2: [0.05, 0.2], 4: [0.05, 0.2]}, kstep=0.01,
                                                         data={}, #'../../tests/_xi/data.npy',
                                                         theory=theory)
    ...
    footprint = BoxFootprint(volume=1e10, nbar=1e-3)
    theory = KaiserTracerPowerSpectrumMultipoles(template=template)
    observable1 = TracerPowerSpectrumMultipolesObservable(klim={0: [0.05, 0.2], 2: [0.05, 0.2]}, kstep=0.01,
                                                          data={}, #'../../tests/_xi/data.npy',
                                                          theory=theory)
    theory = KaiserTracerCorrelationFunctionMultipoles(template=template)
    observable2 = TracerCorrelationFunctionMultipolesObservable(slim={0: [20., 150.], 2: [20., 150.]}, sstep=5.,
                                                                data={}, #'../../tests/_xi/data.npy',
                                                                theory=theory)
